...
const ruCopy: Copy = {
  ...
  other: `Другое`,
  youHaveScored: `Вы набрали`,
  signInToContinue: `Войдите, чтобы продолжить`,
  wipPage: `Эта страница находится в стадии разработки.`,
  purchase: `Покупка`,
  synchingCheckout: `Синхронизация с кассой...`,
  synchingOrder: `Синхронизация с заказом...`,
  family: `Семья`,
  privacy: `Конфиденциальность`,
  purchasePromptTitle: `Разблокируйте неограниченный доступ`,
  purchasePromptWithPrice: <R>(
    variables: { price: any },
    inject: Injector<R>,
  ) => inject(`Улучшите подготовку всего за  {{price}}`, variables),
  purchasePromptContent: `Обновите до пожизненной версии сейчас и получите неограниченный доступ ко всем симуляциям экзаменов и учебным материалам. Обеспечьте свой успех на экзамене по получению гражданства Грузии с помощью GeorgianCitizen.`,
  ...
  signOut: `Выйти`,
  withTermsOfService: `Условиями использования`,
  withPrivacyPolicy: `Политикой конфиденциальности`,
  agreement: <R>(
  ...
  authTitle: `Войдите или создайте аккаунт`,
  ...
  scoreToPass: <R>(variables: { percentage: any }, inject: Injector<R>) =>
    inject(`Наберите {{percentage}} или больше, чтобы пройти!`, variables),
