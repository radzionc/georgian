import { Dimensions } from '@georgian/utils/entities/Dimensions'
import { normalizeToMaxDimension } from '@georgian/utils/normalizeToMaxDimension'
...
export const svgToReact = async ({ svg, componentName }: SvgToReactParams) => {
  ...
  return [
    `import { SvgIconProps } from '@georgian/ui/icons/SvgIconProps'`,
